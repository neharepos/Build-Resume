...
const ThemeSelector = ({ selectedTheme, setSelectedTheme, resumeData, onClose }) => {
    ...
    //  const [activeTab, setActiveTab] = useState(selectedTheme);
    ...
    return (
        ...
        p-4 sm:p-6 bg-gradient-to-r from-white to violet-50 rounded-2xl border border-violet-100'>
            ...
            py-3 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-black rounded-2xl hover:scale-105
            ...
            <div className='grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8'>
                ...
                <div className='lg:col-span-3 bg-white rounded-2xl border border-gray-100 p-4' ref={resumeRef}>
