...
export const infoStyles = {
  ...
  progressBar: _color => `h-full rounded-full transition-all`,
  ...
  certYear: _bgColor => `text-xs font-bold text-white px-3 py-1 rounded-lg`,
  ...
  workDuration: _color => `text-sm font-bold italic`,
